...
/**
 * A very fast input reader to read data from any InputStream (System.in in
 * particular). I primarily use this input reader for competitive programming to
 * get an edge on the time required to read input. That being said, this input
 * reader assumes you know what data types you are reading in and will not do
 * any validation of input whatsoever!
 *
...
public class InputReader {
     ...
     * {@link #nextDoubleFast() nextDoubleFast()} can read. Currently this value
     * is set to 21 because it is the maximum number of digits a double
     * precision float can have at the moment.
     */
     ...
     * Create an InputReader that reads from standard input.
     *
     * @param stream Takes an
     * {@link java.io.InputStream#InputStream() InputStream} as a parameter to
     * read from.
     ...
     *
     * @return Returns the byte value of the next character in the buffer and
     ...
     *
     * @param token The token is a value which we use to stop reading junk out
     * of the stream.
     ...
     * including the new line character. Returns <code>null</code> when there
     * are no more lines.
