...
public class CollectionsOfAffectiveEmojis {
    ...
    private Set<String> setHyperSatisfactionEmojis;
    ...
    public void load() {
        ...
        String[] hyperSatisfactionEmojis = {":triumph:", ":clap:", ":champagne:", ":sparkling_wine:", ":heart_eyes:", ":joy:", ":sparkling_heart:", ":sparkles:", ":face_with_tears_of_joy:", ":exclamation_heart:", ":beers:", ":hearts:", ":high_brightness:", ":kissing_smiling_eyes:", ":trophy:", ":military_medal:", ":military_decoration:", ":birthday:", ":gift_heart:", ":smiling_face_with_smiling_eyes:"};
        ...
        setHyperSatisfactionEmojis = new HashSet(Arrays.asList(hyperSatisfactionEmojis));
    ...
    public Set<String> getSetHyperSatisfactionEmojis() {
        return setHyperSatisfactionEmojis;
    }

    public void setSetHyperSatisfactionEmojis(Set<String> setHyperSatisfactionEmojis) {
        this.setHyperSatisfactionEmojis = setHyperSatisfactionEmojis;
    }
